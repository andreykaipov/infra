...
# Java Minecraft components are now in separate directories:
# - server/         - Minecraft Java server
# - monitoring/     - Player monitor service
# - backup/         - Backup manager service
# - player-monitor/ - Docker image build for player monitor
# - backup-manager/ - Docker image build for backup manager
